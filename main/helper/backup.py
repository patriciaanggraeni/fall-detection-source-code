...
#
# def on_message(client, userdata, msg):
#     global data_buffer, last_save_time, last_message_time
...
#         print("\n==============================================")
#         print(f"Received {message_count} messages in 1 second")
#         print("==============================================\n")
...
#     #     print(f"Time difference since last message: {time_diff} seconds")
#     #     print("========================================================\n")
#
...
#     interpolated_data = np.interp(indices, np.arange(original_length), data)
#
...
#     spline_interpolator = interpolate.interp1d(x, data, kind='cubic')
#     interpolated_data = spline_interpolator(np.linspace(0, original_length - 1, target_length))
#
#     return interpolated_data
